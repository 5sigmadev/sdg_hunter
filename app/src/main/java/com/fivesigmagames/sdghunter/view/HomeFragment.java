...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_cam.setBackgroundDrawable(new BitmapDrawable(getResources(),resized_cam_button)); // API < 16
                //.setBackground(new BitmapDrawable(getResources(),resized_cam_button)); // API >= 16
